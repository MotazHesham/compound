                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{trans('admins.PartyType')}} </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">{{trans('admins.PartyType')}} </h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
                                        <button  class="btn btn-dark" id="titleOfText" data-toggle="modal" onclick="addFunction()">
                                            {{trans('basic.add')}} {{trans('admins.singlePartyType')}}
                                        </button>
                                        &nbsp;
                            ...
                            <div class="table-responsive" style="overflow: hidden;">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>#</th>
                                        <th>{{trans('admins.name_ar')}}</th>
                                        <th>{{trans('admins.name_en')}}</th>
...
@section('script')
    ...
    @include('Admin.PartyType.script')
