                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{trans('admins.Party2')}} </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">{{trans('admins.Party2')}} </h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
                            ...
                            <div class="table-responsive" style="overflow: hidden;">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>#</th>
                                        <th>{{trans('admins.dateC')}}</th>
                                        <th>{{trans('admins.time')}}</th>
                                        <th>{{arabicSingleWords(). trans('admins.singleTenant')}}</th>
                                        <th>{{trans('basic.status')}}</th>
                                        <th>{{trans('admins.type')}}</th>
