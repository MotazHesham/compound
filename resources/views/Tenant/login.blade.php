                    ...
                    <div class="col-12">
                        <form class="form-horizontal m-t-20"  id="login_form">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="id_number" aria-label="Username" name="id_number" aria-describedby="basic-addon1">
                            </div>
            ...
            success: function (data) {
                ...
                if (data == 1) {
                    ...
                    window.setTimeout(function () {
                        location.href = "{{ route('Tenant.dashboard') }}";
                    }, 800);
                } else if (data == 3) {
