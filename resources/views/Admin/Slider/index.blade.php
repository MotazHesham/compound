...
@section('content')
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('admins.Slider') }} </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">{{ trans('admins.Slider') }} </h4>
                                <div class="ml-auto">
                                    <div class="btn-group"> 
                                        <button class="btn btn-dark" id="titleOfText" data-toggle="modal"
                                                onclick="addFunction()">
                                            {{trans('basic.add')}} {{trans('admins.singleSlider')}}
                                        </button>
                                        &nbsp;
                            ...
                            <div class="table-responsive" style="overflow: hidden;">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{trans('admins.Slidertext')}}</th>
                                        <th>{{trans('admins.Slidertype')}}</th> 
    ...
    @include('Admin.Slider.ExchangeForm')
    @include('Admin.Slider.DestroyForm')
