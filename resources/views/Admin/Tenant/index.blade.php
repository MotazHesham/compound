                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{trans('admins.tenant')}} </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">{{trans('admins.tenant')}} </h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
...
{{--                                        </button>--}}
                                        <button  class="btn btn-dark" id="titleOfText" data-toggle="modal" onclick="addFunction()">
                                            {{trans('basic.add')}} {{trans('admins.singleTenant')}}
                                        </button>
                                        &nbsp;
                                        <button  class="btn btn-success" data-toggle="modal" onclick="sendEmails()">
                                            {{trans('admins.sendMail')}}
                                        </button>
                                        &#160;
...
{{--                            </div>--}}
                            ...
                            <div class="table-responsive" style="overflow: hidden;">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{trans('admins.contractNumber')}}</th>
                                        <th>{{trans('admins.singleVilla')}}</th>
        ...
        <!-- footer -->
        <!-- ============================================================== -->
    @include('Admin.Tenant.emailForm')
