                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="example-email">{{trans('admins.membersNumbers')}}</label>
                                <input type="number" id="numbers" name="numbers"  class="form-control"  min="0" max="{{ $party->NumSubscribers }}" >
                                <small>العدد المتاح الأن {{ $party->NumSubscribers }} فقط</small>
                            </div>
                        </div>
