                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{trans('admins.maintenanceOrders')}} </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">{{trans('admins.maintenanceOrders')}} </h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
...
{{--                                            {{trans('basic.add')}} service request--}}
{{--                                        </button>--}}
                                        &nbsp;
    ...
    @include('Admin.Order.ExchangeForm')
