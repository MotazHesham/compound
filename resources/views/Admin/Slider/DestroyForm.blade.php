<div class="modal fade bd-example-modal-lg" id="DestroyModel" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="DestroyForm">
                ...
                <div id="err"></div>
                <input type="hidden" name="piece_id" id="piece_id2">
