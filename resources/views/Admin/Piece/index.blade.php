...
@section('content')
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{getPieceType($WarehouseType)}} </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">{{getPieceType($WarehouseType)}} </h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-dark" id="titleOfText" data-toggle="modal"
                                                onclick="addFunction()">
                                            {{trans('basic.add')}} {{trans('admins.singlePiece')}}
                                        </button>
                                        &nbsp;
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <select name="status" class="custom-select mr-sm-2" id="inline">
                                                    <option value="">{{trans('admins.singleCategory')}}</option>
                                                    @foreach($cats as $row)
                                        ...
                                        <div class="col-sm-12 col-md-1">
                                            <div class="form-actions">
                                                <div class="text-right">
                                                    <button type="submit"
                                                            class="btn btn-info">{{trans('admins.search')}}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive" style="overflow: hidden;">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{trans('admins.pieceNumber')}}</th>
                                        <th>{{trans('admins.quantity')}}</th>
                                        <th>{{arabicSingleWords(). trans('admins.singleCategory')}}</th>
    ...
    @include('Admin.Piece.ExchangeForm')
    @include('Admin.Piece.DestroyForm')
