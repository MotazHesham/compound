<div class="modal fade bd-example-modal-lg" id="modalexchangeOrder" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="formexchangeOrder">
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="saveexchangeOrder" class="btn btn-success"><i class="ti-save"></i> {{trans('basic.save')}}</button>
                </div>
            </form>
        </div>
    </div>
