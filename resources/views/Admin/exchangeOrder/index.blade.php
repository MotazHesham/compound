                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{trans('admins.exchangeOrder')}} </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">{{trans('admins.exchangeOrder')}} </h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
...
{{--                                        </button>--}}
        ...
        <!-- footer -->
        <!-- ============================================================== -->
    @include('Admin.exchangeOrder.form')
...
@section('script')
    ...
    @include('Admin.exchangeOrder.script')
