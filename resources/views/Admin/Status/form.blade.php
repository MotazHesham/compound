            ...
            <form id="formSubmit">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">{{trans('admins.class')}}</label>
                                <select type="text" id="class" name="class" required class="form-control"   >
                                    <option value="btn btn-success">{{trans('admins.green')}}</option>
                                    <option value="btn btn-danger">{{trans('admins.red')}}</option>
                                    <option value="btn btn-info">{{trans('admins.blue')}}</option>
                                </select>
                            </div>
                        </div>
